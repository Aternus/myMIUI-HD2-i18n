...
.method private static getAllAllowedHttpClient(Landroid/content/Context;)Lorg/apache/http/client/HttpClient;
    ...
    :cond_0
    sget-object v2, Lcom/miui/milk/transport/HttpTransport;->sSyncRoot:Ljava/lang/Object;
    ...
    invoke-static {p0, v3}, Lcom/miui/milk/transport/HttpTransport;->getHttpClientSync(Landroid/content/Context;Z)Lorg/apache/http/impl/client/DefaultHttpClient;
...
.method public static getSyncFindlostUrl()Ljava/lang/String;
    ...
    sget-object v1, Lcom/miui/milk/transport/HttpTransport;->SYNC_DN_URL_FINDLOST:Ljava/lang/String;
...
.method public static getSyncPingUrl()Ljava/lang/String;
    ...
    sget-object v1, Lcom/miui/milk/transport/HttpTransport;->SYNC_DN_URL_PING:Ljava/lang/String;
...
.method public static getSyncReadUrl()Ljava/lang/String;
    ...
    sget-object v1, Lcom/miui/milk/transport/HttpTransport;->SYNC_DN_URL_READ:Ljava/lang/String;
...
.method public static getSyncSaveUrl()Ljava/lang/String;
    ...
    sget-object v1, Lcom/miui/milk/transport/HttpTransport;->SYNC_DN_URL_SAVE:Ljava/lang/String;
...
.method private static updateIp(Z)V
    ...
    .prologue
    .line 195
    sget-object v0, Lcom/miui/milk/transport/HttpTransport;->sSyncRoot:Ljava/lang/Object;
    ...
    sput-wide v1, Lcom/miui/milk/transport/HttpTransport;->sIpResolvingTime:J

    .line 198
    const-string v1, "milk.app.miui.com"
    ...
    sput-object v1, Lcom/miui/milk/transport/HttpTransport;->sSyncIp:Ljava/lang/String;
    ...
    sput-object v1, Lcom/miui/milk/transport/HttpTransport;->SYNC_IP_URL_PREFIX:Ljava/lang/String;
    ...
    sput-object v1, Lcom/miui/milk/transport/HttpTransport;->SYNC_IP_URL_SAVE:Ljava/lang/String;
    ...
    sput-object v1, Lcom/miui/milk/transport/HttpTransport;->SYNC_IP_URL_READ:Ljava/lang/String;
    ...
    sput-object v1, Lcom/miui/milk/transport/HttpTransport;->SYNC_IP_URL_CHECK:Ljava/lang/String;
    ...
    sput-object v1, Lcom/miui/milk/transport/HttpTransport;->SYNC_IP_URL_FINDLOST:Ljava/lang/String;
    ...
    sput-object v1, Lcom/miui/milk/transport/HttpTransport;->SYNC_IP_URL_PING:Ljava/lang/String;
...
.method public sendRequest(Ljava/lang/String;Lcom/miui/milk/model/SyncRootProtos$SyncRoot;Ljava/util/HashMap;)Lorg/apache/http/HttpResponse;
    ...
    .line 230
    .local v8, header:Lorg/apache/http/message/BasicHeader;
    invoke-virtual {v9, v8}, Lorg/apache/http/client/methods/HttpPost;->setHeader(Lorg/apache/http/Header;)V

    goto :goto_0

    .line 234
    .end local v8           #header:Lorg/apache/http/message/BasicHeader;
    ...
    .line 240
    .local v6, gout:Ljava/util/zip/GZIPOutputStream;
    invoke-virtual {v6, v13}, Ljava/util/zip/GZIPOutputStream;->write([B)V
    ...
    invoke-direct {v5, v7}, Lorg/apache/http/entity/ByteArrayEntity;-><init>([B)V
    ...
    .end local v6           #gout:Ljava/util/zip/GZIPOutputStream;
    .end local v7           #gzipSrc:[B
    .end local v13           #oriSrc:[B
    :cond_1
    const/4 v14, 0x0
    ...
    iget-object v0, v0, Lcom/miui/milk/transport/HttpTransport;->mContext:Landroid/content/Context;

    move-object v15, v0

    invoke-static {v15}, Lcom/miui/milk/transport/HttpTransport;->getRestrictHttpClient(Landroid/content/Context;)Lorg/apache/http/client/HttpClient;

    move-result-object v15

    invoke-interface {v15, v9}, Lorg/apache/http/client/HttpClient;->execute(Lorg/apache/http/client/methods/HttpUriRequest;)Lorg/apache/http/HttpResponse;
    ...
    invoke-static {v15}, Lcom/miui/milk/transport/HttpTransport;->updateIp(Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    sput-wide v15, Lcom/miui/milk/control/cloud/BaseCloudController;->sLastPingTime:J
    ...
    .line 269
    new-instance v15, Lcom/miui/milk/transport/HttpTransport$GzipDecompressingEntity;

    invoke-interface {v14}, Lorg/apache/http/HttpResponse;->getEntity()Lorg/apache/http/HttpEntity;

    move-result-object v16

    invoke-direct/range {v15 .. v16}, Lcom/miui/milk/transport/HttpTransport$GzipDecompressingEntity;-><init>(Lorg/apache/http/HttpEntity;)V

    invoke-interface {v14, v15}, Lorg/apache/http/HttpResponse;->setEntity(Lorg/apache/http/HttpEntity;)V
    ...
    invoke-static {v15}, Lcom/miui/milk/transport/HttpTransport;->getAllAllowedHttpClient(Landroid/content/Context;)Lorg/apache/http/client/HttpClient;
    ...
    sput-wide v16, Lcom/miui/milk/control/cloud/BaseCloudController;->sLastPingTime:J
...
.method public shutDown()V
    ...
    .line 278
    :try_start_0
    sget-object v1, Lcom/miui/milk/transport/HttpTransport;->sRestrictHttpClient:Lorg/apache/http/client/HttpClient;
    ...
    sput-object v1, Lcom/miui/milk/transport/HttpTransport;->sRestrictHttpClient:Lorg/apache/http/client/HttpClient;

    .line 283
    :cond_0
    sget-object v1, Lcom/miui/milk/transport/HttpTransport;->sAllAllowedHttpClient:Lorg/apache/http/client/HttpClient;
    ...
    sput-object v1, Lcom/miui/milk/transport/HttpTransport;->sAllAllowedHttpClient:Lorg/apache/http/client/HttpClient;
