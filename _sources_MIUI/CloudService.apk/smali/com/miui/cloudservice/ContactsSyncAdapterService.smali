...
.method public onCreate()V
    ...
    .line 34
    sget-object v0, Lcom/miui/cloudservice/ContactsSyncAdapterService;->sSyncAdapterLock:Ljava/lang/Object;

    monitor-enter v0

    .line 35
    :try_start_0
    sget-object v1, Lcom/miui/cloudservice/ContactsSyncAdapterService;->sSyncAdapter:Lcom/miui/cloudservice/ContactsSyncAdapterService$SyncAdapterImpl;

    if-nez v1, :cond_0

    .line 36
    new-instance v1, Lcom/miui/cloudservice/ContactsSyncAdapterService$SyncAdapterImpl;

    invoke-virtual {p0}, Lcom/miui/cloudservice/ContactsSyncAdapterService;->getApplicationContext()Landroid/content/Context;

    move-result-object v2

    invoke-direct {v1, v2}, Lcom/miui/cloudservice/ContactsSyncAdapterService$SyncAdapterImpl;-><init>(Landroid/content/Context;)V

    sput-object v1, Lcom/miui/cloudservice/ContactsSyncAdapterService;->sSyncAdapter:Lcom/miui/cloudservice/ContactsSyncAdapterService$SyncAdapterImpl;
