...
# static fields
.field private static final REPORT_HDR:Ljava/lang/String;
...
.method private reportSummary(Ljava/lang/String;Ljava/io/FileFilter;)V
    ...
    .line 232
    .local v7, countFail:I
    const/4 v6, 0x0

    .line 234
    .local v6, countErrors:I
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/voicedialer/VoiceDialerTester;->mWavFiles:[Lcom/android/voicedialer/VoiceDialerTester$WavFile;

    move-object v2, v0

    .local v2, arr$:[Lcom/android/voicedialer/VoiceDialerTester$WavFile;
    array-length v10, v2
    ...
    .line 235
    .local v13, wf:Lcom/android/voicedialer/VoiceDialerTester$WavFile;
    if-eqz p2, :cond_0

    iget-object v14, v13, Lcom/android/voicedialer/VoiceDialerTester$WavFile;->mFile:Ljava/io/File;
    ...
    .line 237
    iget v14, v13, Lcom/android/voicedialer/VoiceDialerTester$WavFile;->mRank:I

    const/4 v15, 0x1

    if-ne v14, v15, :cond_1

    iget v14, v13, Lcom/android/voicedialer/VoiceDialerTester$WavFile;->mTotal:I
    ...
    .line 246
    .end local v13           #wf:Lcom/android/voicedialer/VoiceDialerTester$WavFile;
    :cond_7
    const-string v14, "%6s %6s %6s %6s %6s %6s %6s %s"
    ...
    invoke-static {v4, v12}, Lcom/android/voicedialer/VoiceDialerTester;->countString(II)Ljava/lang/String;
    ...
    invoke-static {v5, v12}, Lcom/android/voicedialer/VoiceDialerTester;->countString(II)Ljava/lang/String;
    ...
    invoke-static {v8, v12}, Lcom/android/voicedialer/VoiceDialerTester;->countString(II)Ljava/lang/String;
    ...
    invoke-static {v3, v12}, Lcom/android/voicedialer/VoiceDialerTester;->countString(II)Ljava/lang/String;
    ...
    invoke-static {v7, v12}, Lcom/android/voicedialer/VoiceDialerTester;->countString(II)Ljava/lang/String;
    ...
    invoke-static {v6, v12}, Lcom/android/voicedialer/VoiceDialerTester;->countString(II)Ljava/lang/String;
    ...
    const-string v14, "VoiceDialerTester"
...
.method private reportSummaryForEachDir()V
    ...
    .prologue
    const-string v10, "VoiceDialerTester"
    ...
    const-string v9, "Summary of utterances by directory"
    ...
    sget-object v9, Lcom/android/voicedialer/VoiceDialerTester;->REPORT_HDR:Ljava/lang/String;
...
.method private reportSummaryForEachFileName()V
    ...
    .prologue
    const-string v8, "VoiceDialerTester"
    ...
    const-string v7, "Summary of utternaces by filename"
    ...
    sget-object v7, Lcom/android/voicedialer/VoiceDialerTester;->REPORT_HDR:Ljava/lang/String;
...
.method public report()V
    ...
    const-string v4, "List of all utterances tested"
    ...
    iget v5, v3, Lcom/android/voicedialer/VoiceDialerTester$WavFile;->mRank:I
    ...
    iget v5, v3, Lcom/android/voicedialer/VoiceDialerTester$WavFile;->mTotal:I
    ...
    iget-object v5, v3, Lcom/android/voicedialer/VoiceDialerTester$WavFile;->mFile:Ljava/io/File;
    ...
    iget-object v6, v3, Lcom/android/voicedialer/VoiceDialerTester$WavFile;->mMessage:Ljava/lang/String;
    ...
    const-string v4, "Summary of all utterances"
    ...
    sget-object v4, Lcom/android/voicedialer/VoiceDialerTester;->REPORT_HDR:Ljava/lang/String;
