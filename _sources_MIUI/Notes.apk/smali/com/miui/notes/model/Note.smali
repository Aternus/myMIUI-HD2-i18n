...
.method public static declared-synchronized getNewNoteId(Landroid/content/Context;J)J
    ...
    .prologue
    .line 28
    const-class v7, Lcom/miui/notes/model/Note;
    ...
    .line 33
    const-string v8, "local_modified"
    ...
    sget-object v9, Landroid/provider/Notes;->CONTENT_NOTE_URI:Landroid/net/Uri;
...
.method public syncNote(Landroid/content/Context;J)Z
    ...
    iget-object v2, p0, Lcom/miui/notes/model/Note;->mNoteDiffValues:Landroid/content/ContentValues;
    ...
    const-string v1, "Update note error, should not happen"
    ...
    invoke-virtual {v0, p1, p2, p3}, Lcom/miui/notes/model/Note$NoteData;->pushIntoContentResolver(Landroid/content/Context;J)Landroid/net/Uri;
