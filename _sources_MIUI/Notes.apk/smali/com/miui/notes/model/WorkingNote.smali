...
.method private loadNoteData()V
    ...
    const-string v1, "Wrong note type with type:"
    ...
    const-string v1, "No data with id:"

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget-wide v1, p0, Lcom/miui/notes/model/WorkingNote;->mNoteId:J
...
.method public declared-synchronized saveNote()Z
    ...
    iget-wide v1, p0, Lcom/miui/notes/model/WorkingNote;->mFolderId:J

    invoke-static {v0, v1, v2}, Lcom/miui/notes/model/Note;->getNewNoteId(Landroid/content/Context;J)J

    move-result-wide v0

    iput-wide v0, p0, Lcom/miui/notes/model/WorkingNote;->mNoteId:J
    ...
    const-string v2, "Create new note fail with id:"
