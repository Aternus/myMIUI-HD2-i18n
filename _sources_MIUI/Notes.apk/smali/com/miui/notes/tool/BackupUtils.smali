...
.method public static declared-synchronized getInstance(Landroid/content/Context;)Lcom/miui/notes/tool/BackupUtils;
    ...
    .prologue
    .line 26
    const-class v0, Lcom/miui/notes/tool/BackupUtils;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/miui/notes/tool/BackupUtils;->sInstance:Lcom/miui/notes/tool/BackupUtils;

    if-nez v1, :cond_0

    .line 27
    new-instance v1, Lcom/miui/notes/tool/BackupUtils;

    invoke-direct {v1, p0}, Lcom/miui/notes/tool/BackupUtils;-><init>(Landroid/content/Context;)V

    sput-object v1, Lcom/miui/notes/tool/BackupUtils;->sInstance:Lcom/miui/notes/tool/BackupUtils;
