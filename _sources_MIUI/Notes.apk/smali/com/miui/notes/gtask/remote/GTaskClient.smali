...
.method public static declared-synchronized getInstance()Lcom/miui/notes/gtask/remote/GTaskClient;
    ...
    :try_start_0
    sget-object v1, Lcom/miui/notes/gtask/remote/GTaskClient;->mInstance:Lcom/miui/notes/gtask/remote/GTaskClient;

    if-nez v1, :cond_0

    .line 91
    new-instance v1, Lcom/miui/notes/gtask/remote/GTaskClient;

    invoke-direct {v1}, Lcom/miui/notes/gtask/remote/GTaskClient;-><init>()V

    sput-object v1, Lcom/miui/notes/gtask/remote/GTaskClient;->mInstance:Lcom/miui/notes/gtask/remote/GTaskClient;
...
.method private loginGoogleAccount(Landroid/app/Activity;Z)Ljava/lang/String;
    ...
    const-string v6, "there is no available google account"
    ...
    iput-object v0, v1, Lcom/miui/notes/gtask/remote/GTaskClient;->mAccount:Landroid/accounts/Account;

    .line 177
    const-string v5, "goanna_mobile"
    ...
    .line 180
    .local v11, accountManagerFuture:Landroid/accounts/AccountManagerFuture;,"Landroid/accounts/AccountManagerFuture<Landroid/os/Bundle;>;"
    :try_start_0
    ...
    .line 181
    .local v16, authTokenBundle:Landroid/os/Bundle;
    ...
    .line 182
    .local v15, authToken:Ljava/lang/String;
    if-eqz p2, :cond_2

    .line 183
    const-string v5, "com.google"

    invoke-virtual {v3, v5, v15}, Landroid/accounts/AccountManager;->invalidateAuthToken(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v1, v2}, Lcom/miui/notes/gtask/remote/GTaskClient;->loginGoogleAccount(Landroid/app/Activity;Z)Ljava/lang/String;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    .end local v16           #authTokenBundle:Landroid/os/Bundle;
    :cond_2
    :goto_2
    move-object v5, v15
    ...
    .line 163
    .end local v11           #accountManagerFuture:Landroid/accounts/AccountManagerFuture;,"Landroid/accounts/AccountManagerFuture<Landroid/os/Bundle;>;"
    .end local v15           #authToken:Ljava/lang/String;
    ...
    const-string v6, "unable to get an account with the same name in the settings"
    ...
    .line 186
    .restart local v11       #accountManagerFuture:Landroid/accounts/AccountManagerFuture;,"Landroid/accounts/AccountManagerFuture<Landroid/os/Bundle;>;"
    :catch_0
    move-exception v5
    ...
    const-string v6, "get auth token failed"
    ...
    .restart local v15       #authToken:Ljava/lang/String;
    goto :goto_2
.end method
...
.method private postRequest(Lorg/json/JSONObject;)Lorg/json/JSONObject;
    ...
    .prologue
    const-string v9, "postRequest failed"
    ...
    invoke-direct {v6, v9}, Lcom/miui/notes/gtask/exception/NetworkFailureException;-><init>(Ljava/lang/String;)V
...
.method private tryToLoginGtask(Landroid/app/Activity;Ljava/lang/String;)Z
    ...
    .line 200
    sget-object v0, Lcom/miui/notes/gtask/remote/GTaskClient;->TAG:Ljava/lang/String;

    const-string v1, "login google account failed"
    ...
    const-string v1, "login gtask failed"
...
.method public getTaskLists()Lorg/json/JSONArray;
    ...
    const-string v12, "gettasklists: httpget failed"
    ...
    invoke-direct {v10, v12}, Lcom/miui/notes/gtask/exception/NetworkFailureException;-><init>(Ljava/lang/String;)V
...
.method public login(Landroid/app/Activity;)Z
    ...
    .line 100
    .local v2, interval:J
    iget-wide v6, p0, Lcom/miui/notes/gtask/remote/GTaskClient;->mLastLoginTime:J
    ...
    .line 101
    iput-boolean v10, p0, Lcom/miui/notes/gtask/remote/GTaskClient;->mLoggedin:Z
    ...
    const-string v7, "already logged in"
    ...
    iput-wide v6, p0, Lcom/miui/notes/gtask/remote/GTaskClient;->mLastLoginTime:J

    .line 117
    invoke-direct {p0, p1, v10}, Lcom/miui/notes/gtask/remote/GTaskClient;->loginGoogleAccount(Landroid/app/Activity;Z)Ljava/lang/String;
    ...
    const-string v7, "login google account failed"
    ...
    .line 124
    :cond_3
    iget-object v6, p0, Lcom/miui/notes/gtask/remote/GTaskClient;->mAccount:Landroid/accounts/Account;
    ...
    const-string v7, "https://mail.google.com/tasks/"
    ...
    iput-object v6, p0, Lcom/miui/notes/gtask/remote/GTaskClient;->mGetUrl:Ljava/lang/String;
    ...
    iput-object v6, p0, Lcom/miui/notes/gtask/remote/GTaskClient;->mPostUrl:Ljava/lang/String;
    ...
    .line 134
    iput-boolean v11, p0, Lcom/miui/notes/gtask/remote/GTaskClient;->mLoggedin:Z
    ...
    .line 140
    const-string v6, "https://mail.google.com/tasks/ig"

    iput-object v6, p0, Lcom/miui/notes/gtask/remote/GTaskClient;->mGetUrl:Ljava/lang/String;

    .line 141
    const-string v6, "https://mail.google.com/tasks/r/ig"
