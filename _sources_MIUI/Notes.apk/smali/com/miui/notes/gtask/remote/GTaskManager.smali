...
.method private addLocalNode(Lcom/miui/notes/gtask/data/Node;)V
    ...
    iget-boolean v0, v0, Lcom/miui/notes/gtask/remote/GTaskManager;->mCancelled:Z
    ...
    instance-of v0, v0, Lcom/miui/notes/gtask/data/TaskList;
    ...
    const-string v16, "[MIUI_Notes]Default"
    ...
    .line 518
    new-instance v14, Lcom/miui/notes/gtask/data/SqlNote;

    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/miui/notes/gtask/remote/GTaskManager;->mContext:Landroid/content/Context;

    move-object v15, v0

    const-wide/16 v16, 0x0

    invoke-direct/range {v14 .. v17}, Lcom/miui/notes/gtask/data/SqlNote;-><init>(Landroid/content/Context;J)V

    .line 572
    .local v14, sqlNote:Lcom/miui/notes/gtask/data/SqlNote;
    :goto_1
    invoke-virtual/range {p1 .. p1}, Lcom/miui/notes/gtask/data/Node;->getGid()Ljava/lang/String;

    move-result-object v15

    invoke-virtual {v14, v15}, Lcom/miui/notes/gtask/data/SqlNote;->setGtaskId(Ljava/lang/String;)V

    .line 573
    const/4 v15, 0x0

    invoke-virtual {v14, v15}, Lcom/miui/notes/gtask/data/SqlNote;->commit(Z)V

    .line 576
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/miui/notes/gtask/remote/GTaskManager;->mGidToNid:Ljava/util/HashMap;
    ...
    invoke-virtual {v14}, Lcom/miui/notes/gtask/data/SqlNote;->getId()J
    ...
    iget-object v0, v0, Lcom/miui/notes/gtask/remote/GTaskManager;->mNidToGid:Ljava/util/HashMap;
    ...
    invoke-direct {v0, v1, v2}, Lcom/miui/notes/gtask/remote/GTaskManager;->updateRemoteMeta(Ljava/lang/String;Lcom/miui/notes/gtask/data/SqlNote;)V

    goto :goto_0

    .line 519
    .end local v14           #sqlNote:Lcom/miui/notes/gtask/data/SqlNote;
    :cond_1
    invoke-virtual/range {p1 .. p1}, Lcom/miui/notes/gtask/data/Node;->getName()Ljava/lang/String;

    move-result-object v15

    const-string v16, "[MIUI_Notes]Call_Note"
    ...
    .restart local v14       #sqlNote:Lcom/miui/notes/gtask/data/SqlNote;
    goto :goto_1
    ...
    invoke-direct {v14, v15}, Lcom/miui/notes/gtask/data/SqlNote;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v14, v15}, Lcom/miui/notes/gtask/data/SqlNote;->setContent(Lorg/json/JSONObject;)Z

    .line 525
    const-wide/16 v15, 0x0

    invoke-virtual/range {v14 .. v16}, Lcom/miui/notes/gtask/data/SqlNote;->setParentId(J)V
    ...
    .line 531
    .local v11, js:Lorg/json/JSONObject;
    :try_start_0
    const-string v15, "meta_note"
    ...
    .line 533
    .local v12, note:Lorg/json/JSONObject;
    ...
    iget-object v0, v0, Lcom/miui/notes/gtask/remote/GTaskManager;->mContentResolver:Landroid/content/ContentResolver;

    move-object v15, v0

    invoke-static {v15, v9, v10}, Lcom/miui/notes/tool/DataUtils;->existInNoteDatabase(Landroid/content/ContentResolver;J)Z
    ...
    .line 542
    .end local v9           #id:J
    .end local v12           #note:Lorg/json/JSONObject;
    :cond_4
    ...
    .line 544
    .local v4, dataArray:Lorg/json/JSONArray;
    const/4 v8, 0x0
    ...
    invoke-static {v15, v5, v6}, Lcom/miui/notes/tool/DataUtils;->existInDataDatabase(Landroid/content/ContentResolver;J)Z
    ...
    .end local v4           #dataArray:Lorg/json/JSONArray;
    .end local v8           #i:I
    :catch_0
    move-exception v15
    ...
    sget-object v15, Lcom/miui/notes/gtask/remote/GTaskManager;->TAG:Ljava/lang/String;
    ...
    :cond_6
    invoke-virtual {v14, v11}, Lcom/miui/notes/gtask/data/SqlNote;->setContent(Lorg/json/JSONObject;)Z
    ...
    check-cast v0, Lcom/miui/notes/gtask/data/Task;

    move-object v3, v0

    invoke-virtual {v3}, Lcom/miui/notes/gtask/data/Task;->getParent()Lcom/miui/notes/gtask/data/TaskList;

    move-result-object v16

    invoke-virtual/range {v16 .. v16}, Lcom/miui/notes/gtask/data/TaskList;->getGid()Ljava/lang/String;
    ...
    .line 564
    .local v13, parentId:Ljava/lang/Long;
    if-nez v13, :cond_7

    .line 565
    sget-object v15, Lcom/miui/notes/gtask/remote/GTaskManager;->TAG:Ljava/lang/String;

    const-string v16, "cannot find task\'s parent id locally"

    invoke-static/range {v15 .. v16}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    .line 566
    new-instance v15, Lcom/miui/notes/gtask/exception/ActionFailureException;

    const-string v16, "cannot add local node"

    invoke-direct/range {v15 .. v16}, Lcom/miui/notes/gtask/exception/ActionFailureException;-><init>(Ljava/lang/String;)V
...
.method private addRemoteNode(Lcom/miui/notes/gtask/data/Node;Landroid/database/Cursor;)V
    ...
    .restart local p1
    :cond_0
    new-instance v10, Lcom/miui/notes/gtask/data/SqlNote;
    ...
    invoke-direct {v0, v1, v2}, Lcom/miui/notes/gtask/data/SqlNote;-><init>(Landroid/content/Context;Landroid/database/Cursor;)V

    .line 615
    .local v10, sqlNote:Lcom/miui/notes/gtask/data/SqlNote;
    invoke-virtual {v10}, Lcom/miui/notes/gtask/data/SqlNote;->isNoteType()Z
    ...
    invoke-virtual {v10}, Lcom/miui/notes/gtask/data/SqlNote;->getContent()Lorg/json/JSONObject;

    move-result-object v13

    invoke-virtual {v11, v13}, Lcom/miui/notes/gtask/data/Task;->setContentByLocalJSON(Lorg/json/JSONObject;)V
    ...
    invoke-virtual {v10}, Lcom/miui/notes/gtask/data/SqlNote;->getParentId()J
    ...
    .line 620
    .local v9, parentGid:Ljava/lang/String;
    if-nez v9, :cond_1

    .line 621
    sget-object v13, Lcom/miui/notes/gtask/remote/GTaskManager;->TAG:Ljava/lang/String;

    const-string v14, "cannot find task\'s parent tasklist"
    ...
    const-string v14, "cannot add remote task"
    ...
    iget-object v0, v0, Lcom/miui/notes/gtask/remote/GTaskManager;->mGTaskListHashMap:Ljava/util/HashMap;
    ...
    .end local p1
    check-cast p1, Lcom/miui/notes/gtask/data/TaskList;

    move-object/from16 v0, p1

    move-object v1, v11

    invoke-virtual {v0, v1}, Lcom/miui/notes/gtask/data/TaskList;->addChildTask(Lcom/miui/notes/gtask/data/Task;)Z
    ...
    invoke-virtual {v13, v11}, Lcom/miui/notes/gtask/remote/GTaskClient;->createTask(Lcom/miui/notes/gtask/data/Task;)V

    .line 627
    move-object v8, v11

    .line 630
    .local v8, n:Lcom/miui/notes/gtask/data/Node;
    invoke-virtual {v11}, Lcom/miui/notes/gtask/data/Task;->getGid()Ljava/lang/String;
    ...
    .line 669
    .end local v9           #parentGid:Ljava/lang/String;
    .end local v11           #task:Lcom/miui/notes/gtask/data/Task;
    :goto_1
    invoke-virtual {v8}, Lcom/miui/notes/gtask/data/Node;->getGid()Ljava/lang/String;

    move-result-object v13

    invoke-virtual {v10, v13}, Lcom/miui/notes/gtask/data/SqlNote;->setGtaskId(Ljava/lang/String;)V

    .line 670
    const/4 v13, 0x0

    invoke-virtual {v10, v13}, Lcom/miui/notes/gtask/data/SqlNote;->commit(Z)V

    .line 671
    invoke-virtual {v10}, Lcom/miui/notes/gtask/data/SqlNote;->resetLocalModified()V
    ...
    invoke-virtual {v10}, Lcom/miui/notes/gtask/data/SqlNote;->getId()J
    ...
    .line 632
    .end local v8           #n:Lcom/miui/notes/gtask/data/Node;
    .restart local p1
    :cond_2
    const/4 v12, 0x0
    ...
    .line 644
    .local v6, iter:Ljava/util/Iterator;,"Ljava/util/Iterator<Ljava/util/Map$Entry<Ljava/lang/String;Lcom/miui/notes/gtask/data/TaskList;>;>;"
    :cond_3
    ...
    .line 646
    .local v3, entry:Ljava/util/Map$Entry;,"Ljava/util/Map$Entry<Ljava/lang/String;Lcom/miui/notes/gtask/data/TaskList;>;"
    ...
    check-cast v7, Lcom/miui/notes/gtask/data/TaskList;

    .line 649
    .local v7, list:Lcom/miui/notes/gtask/data/TaskList;
    invoke-virtual {v7}, Lcom/miui/notes/gtask/data/TaskList;->getName()Ljava/lang/String;
    ...
    iget-object v0, v0, Lcom/miui/notes/gtask/remote/GTaskManager;->mGTaskHashMap:Ljava/util/HashMap;
    ...
    .line 659
    .end local v3           #entry:Ljava/util/Map$Entry;,"Ljava/util/Map$Entry<Ljava/lang/String;Lcom/miui/notes/gtask/data/TaskList;>;"
    .end local v5           #gid:Ljava/lang/String;
    .end local v7           #list:Lcom/miui/notes/gtask/data/TaskList;
    :cond_4
    if-nez v12, :cond_5
    ...
    .line 661
    .restart local v12       #tasklist:Lcom/miui/notes/gtask/data/TaskList;
    invoke-virtual {v10}, Lcom/miui/notes/gtask/data/SqlNote;->getContent()Lorg/json/JSONObject;

    move-result-object v13

    invoke-virtual {v12, v13}, Lcom/miui/notes/gtask/data/TaskList;->setContentByLocalJSON(Lorg/json/JSONObject;)V
    ...
    invoke-virtual {v13, v12}, Lcom/miui/notes/gtask/remote/GTaskClient;->createTaskList(Lcom/miui/notes/gtask/data/TaskList;)V
    ...
    invoke-virtual {v12}, Lcom/miui/notes/gtask/data/TaskList;->getGid()Ljava/lang/String;
    ...
    .restart local v8       #n:Lcom/miui/notes/gtask/data/Node;
    goto/16 :goto_1

    .line 638
    .end local v6           #iter:Ljava/util/Iterator;,"Ljava/util/Iterator<Ljava/util/Map$Entry<Ljava/lang/String;Lcom/miui/notes/gtask/data/TaskList;>;>;"
    .end local v8           #n:Lcom/miui/notes/gtask/data/Node;
    :cond_6
    invoke-virtual {v10}, Lcom/miui/notes/gtask/data/SqlNote;->getId()J
    ...
    invoke-virtual {v10}, Lcom/miui/notes/gtask/data/SqlNote;->getSnippet()Ljava/lang/String;
...
.method public static declared-synchronized getInstance()Lcom/miui/notes/gtask/remote/GTaskManager;
    ...
    :try_start_0
    sget-object v1, Lcom/miui/notes/gtask/remote/GTaskManager;->mInstance:Lcom/miui/notes/gtask/remote/GTaskManager;

    if-nez v1, :cond_0

    .line 88
    new-instance v1, Lcom/miui/notes/gtask/remote/GTaskManager;

    invoke-direct {v1}, Lcom/miui/notes/gtask/remote/GTaskManager;-><init>()V

    sput-object v1, Lcom/miui/notes/gtask/remote/GTaskManager;->mInstance:Lcom/miui/notes/gtask/remote/GTaskManager;
...
.method private updateLocalNode(Lcom/miui/notes/gtask/data/Node;Landroid/database/Cursor;)V
    ...
    .line 590
    :cond_0
    new-instance v2, Lcom/miui/notes/gtask/data/SqlNote;

    iget-object v3, p0, Lcom/miui/notes/gtask/remote/GTaskManager;->mContext:Landroid/content/Context;

    invoke-direct {v2, v3, p2}, Lcom/miui/notes/gtask/data/SqlNote;-><init>(Landroid/content/Context;Landroid/database/Cursor;)V

    .line 591
    .local v2, sqlNote:Lcom/miui/notes/gtask/data/SqlNote;
    invoke-virtual {p1}, Lcom/miui/notes/gtask/data/Node;->getLocalJSONFromContent()Lorg/json/JSONObject;

    move-result-object v3

    invoke-virtual {v2, v3}, Lcom/miui/notes/gtask/data/SqlNote;->setContent(Lorg/json/JSONObject;)Z

    .line 593
    instance-of v3, p1, Lcom/miui/notes/gtask/data/Task;
    ...
    invoke-virtual {v3}, Lcom/miui/notes/gtask/data/TaskList;->getGid()Ljava/lang/String;
    ...
    .line 595
    .local v1, parentId:Ljava/lang/Long;
    :goto_1
    if-nez v1, :cond_2
    ...
    const-string v4, "cannot find task\'s parent id locally"
    ...
    const-string v4, "cannot update local node"
    ...
    .line 593
    .end local v1           #parentId:Ljava/lang/Long;
    :cond_1
    ...
    .line 599
    .restart local v1       #parentId:Ljava/lang/Long;
    :cond_2
    invoke-virtual {v1}, Ljava/lang/Long;->longValue()J

    move-result-wide v3

    invoke-virtual {v2, v3, v4}, Lcom/miui/notes/gtask/data/SqlNote;->setParentId(J)V

    .line 600
    const/4 v3, 0x1

    invoke-virtual {v2, v3}, Lcom/miui/notes/gtask/data/SqlNote;->commit(Z)V
    ...
    invoke-direct {p0, v3, v2}, Lcom/miui/notes/gtask/remote/GTaskManager;->updateRemoteMeta(Ljava/lang/String;Lcom/miui/notes/gtask/data/SqlNote;)V
...
.method private updateRemoteNode(Lcom/miui/notes/gtask/data/Node;Landroid/database/Cursor;)V
    ...
    .prologue
    .line 680
    iget-boolean v6, p0, Lcom/miui/notes/gtask/remote/GTaskManager;->mCancelled:Z
    ...
    .line 684
    :cond_0
    new-instance v4, Lcom/miui/notes/gtask/data/SqlNote;

    iget-object v6, p0, Lcom/miui/notes/gtask/remote/GTaskManager;->mContext:Landroid/content/Context;

    invoke-direct {v4, v6, p2}, Lcom/miui/notes/gtask/data/SqlNote;-><init>(Landroid/content/Context;Landroid/database/Cursor;)V

    .line 687
    .local v4, sqlNote:Lcom/miui/notes/gtask/data/SqlNote;
    invoke-virtual {v4}, Lcom/miui/notes/gtask/data/SqlNote;->getContent()Lorg/json/JSONObject;

    move-result-object v6

    invoke-virtual {p1, v6}, Lcom/miui/notes/gtask/data/Node;->setContentByLocalJSON(Lorg/json/JSONObject;)V
    ...
    invoke-virtual {v6, p1}, Lcom/miui/notes/gtask/remote/GTaskClient;->addUpdateNode(Lcom/miui/notes/gtask/data/Node;)V
    ...
    invoke-direct {p0, v6, v4}, Lcom/miui/notes/gtask/remote/GTaskManager;->updateRemoteMeta(Ljava/lang/String;Lcom/miui/notes/gtask/data/SqlNote;)V

    .line 694
    invoke-virtual {v4}, Lcom/miui/notes/gtask/data/SqlNote;->isNoteType()Z
    ...
    .line 696
    .local v5, task:Lcom/miui/notes/gtask/data/Task;
    invoke-virtual {v5}, Lcom/miui/notes/gtask/data/Task;->getParent()Lcom/miui/notes/gtask/data/TaskList;

    move-result-object v3

    .line 698
    .local v3, preParentList:Lcom/miui/notes/gtask/data/TaskList;
    iget-object v6, p0, Lcom/miui/notes/gtask/remote/GTaskManager;->mNidToGid:Ljava/util/HashMap;

    invoke-virtual {v4}, Lcom/miui/notes/gtask/data/SqlNote;->getParentId()J
    ...
    .line 699
    .local v1, curParentGid:Ljava/lang/String;
    if-nez v1, :cond_1

    .line 700
    sget-object v6, Lcom/miui/notes/gtask/remote/GTaskManager;->TAG:Ljava/lang/String;

    const-string v7, "cannot find task\'s parent tasklist"
    ...
    const-string v7, "cannot update remote task"
    ...
    .line 703
    :cond_1
    iget-object v6, p0, Lcom/miui/notes/gtask/remote/GTaskManager;->mGTaskListHashMap:Ljava/util/HashMap;

    invoke-virtual {v6, v1}, Ljava/util/HashMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lcom/miui/notes/gtask/data/TaskList;

    .line 705
    .local v2, curParentList:Lcom/miui/notes/gtask/data/TaskList;
    if-eq v3, v2, :cond_2

    .line 706
    invoke-virtual {v3, v5}, Lcom/miui/notes/gtask/data/TaskList;->removeChildTask(Lcom/miui/notes/gtask/data/Task;)Z

    .line 707
    invoke-virtual {v2, v5}, Lcom/miui/notes/gtask/data/TaskList;->addChildTask(Lcom/miui/notes/gtask/data/Task;)Z
    ...
    invoke-virtual {v6, v5, v3, v2}, Lcom/miui/notes/gtask/remote/GTaskClient;->moveTask(Lcom/miui/notes/gtask/data/Task;Lcom/miui/notes/gtask/data/TaskList;Lcom/miui/notes/gtask/data/TaskList;)V

    .line 713
    .end local v1           #curParentGid:Ljava/lang/String;
    .end local v2           #curParentList:Lcom/miui/notes/gtask/data/TaskList;
    .end local v3           #preParentList:Lcom/miui/notes/gtask/data/TaskList;
    .end local v5           #task:Lcom/miui/notes/gtask/data/Task;
    :cond_2
    invoke-virtual {v4}, Lcom/miui/notes/gtask/data/SqlNote;->resetLocalModified()V

    .line 714
    const/4 v6, 0x1

    invoke-virtual {v4, v6}, Lcom/miui/notes/gtask/data/SqlNote;->commit(Z)V
...
.method public sync(Landroid/content/Context;Lcom/miui/notes/gtask/remote/GTaskASyncTask;)I
    ...
    .line 99
    iget-boolean v2, p0, Lcom/miui/notes/gtask/remote/GTaskManager;->mSyncing:Z
    ...
    iput-object v2, p0, Lcom/miui/notes/gtask/remote/GTaskManager;->mContentResolver:Landroid/content/ContentResolver;

    .line 105
    iput-boolean v5, p0, Lcom/miui/notes/gtask/remote/GTaskManager;->mSyncing:Z

    .line 106
    iput-boolean v4, p0, Lcom/miui/notes/gtask/remote/GTaskManager;->mCancelled:Z

    .line 107
    iget-object v2, p0, Lcom/miui/notes/gtask/remote/GTaskManager;->mGTaskListHashMap:Ljava/util/HashMap;

    invoke-virtual {v2}, Ljava/util/HashMap;->clear()V

    .line 108
    iget-object v2, p0, Lcom/miui/notes/gtask/remote/GTaskManager;->mGTaskHashMap:Ljava/util/HashMap;

    invoke-virtual {v2}, Ljava/util/HashMap;->clear()V

    .line 109
    iget-object v2, p0, Lcom/miui/notes/gtask/remote/GTaskManager;->mMetaHashMap:Ljava/util/HashMap;

    invoke-virtual {v2}, Ljava/util/HashMap;->clear()V

    .line 110
    iget-object v2, p0, Lcom/miui/notes/gtask/remote/GTaskManager;->mLocalDeleteIdMap:Ljava/util/HashSet;

    invoke-virtual {v2}, Ljava/util/HashSet;->clear()V

    .line 111
    iget-object v2, p0, Lcom/miui/notes/gtask/remote/GTaskManager;->mGidToNid:Ljava/util/HashMap;

    invoke-virtual {v2}, Ljava/util/HashMap;->clear()V

    .line 112
    iget-object v2, p0, Lcom/miui/notes/gtask/remote/GTaskManager;->mNidToGid:Ljava/util/HashMap;
    ...
    .line 120
    iget-object v2, p0, Lcom/miui/notes/gtask/remote/GTaskManager;->mActivity:Landroid/app/Activity;

    invoke-virtual {v0, v2}, Lcom/miui/notes/gtask/remote/GTaskClient;->login(Landroid/app/Activity;)Z
    ...
    .line 121
    new-instance v2, Lcom/miui/notes/gtask/exception/NetworkFailureException;

    const-string v3, "login google task failed"

    invoke-direct {v2, v3}, Lcom/miui/notes/gtask/exception/NetworkFailureException;-><init>(Ljava/lang/String;)V
    ...
    .line 149
    iput-boolean v4, p0, Lcom/miui/notes/gtask/remote/GTaskManager;->mSyncing:Z
    ...
    invoke-virtual {p2, v2}, Lcom/miui/notes/gtask/remote/GTaskASyncTask;->publishProgess(Ljava/lang/String;)V
