...
.method public getLocalJSONFromContent()Lorg/json/JSONObject;
    ...
    :try_start_0
    iget-object v7, p0, Lcom/miui/notes/gtask/data/Task;->mMetaInfo:Lorg/json/JSONObject;
    ...
    .line 197
    sget-object v7, Lcom/miui/notes/gtask/data/Task;->TAG:Ljava/lang/String;

    const-string v8, "the note seems to be an empty one"
...
.method public getSyncAction(Landroid/database/Cursor;)I
    ...
    :try_start_0
    iget-object v2, p0, Lcom/miui/notes/gtask/data/Task;->mMetaInfo:Lorg/json/JSONObject;
    ...
    const-string v3, "it seems that note meta has been deleted"
    ...
    const-string v3, "remote note id seems to be deleted"
    ...
    const-string v3, "note id doesn\'t match"
