...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v5, p0, Lcom/miui/notes/gtask/data/SqlNote;->mSnippet:Ljava/lang/String;
    ...
    iput-object v5, p0, Lcom/miui/notes/gtask/data/SqlNote;->mGtaskId:Ljava/lang/String;
...
.method public commit(Z)V
    ...
    sget-object v2, Landroid/provider/Notes;->CONTENT_NOTE_URI:Landroid/net/Uri;
...
.method public getContent()Lorg/json/JSONObject;
    ...
    iget-boolean v7, p0, Lcom/miui/notes/gtask/data/SqlNote;->mIsCreate:Z

    if-eqz v7, :cond_0

    .line 367
    sget-object v7, Lcom/miui/notes/gtask/data/SqlNote;->TAG:Ljava/lang/String;

    const-string v8, "it seems that we haven\'t created this in database yet"
    ...
    iget v7, p0, Lcom/miui/notes/gtask/data/SqlNote;->mType:I
    ...
    .line 374
    const-string v7, "alert_date"

    iget-wide v8, p0, Lcom/miui/notes/gtask/data/SqlNote;->mAlertDate:J

    invoke-virtual {v5, v7, v8, v9}, Lorg/json/JSONObject;->put(Ljava/lang/String;J)Lorg/json/JSONObject;

    .line 375
    const-string v7, "bg_color_id"

    iget v8, p0, Lcom/miui/notes/gtask/data/SqlNote;->mBgColorId:I
    ...
    iget-wide v8, p0, Lcom/miui/notes/gtask/data/SqlNote;->mCreatedDate:J

    invoke-virtual {v5, v7, v8, v9}, Lorg/json/JSONObject;->put(Ljava/lang/String;J)Lorg/json/JSONObject;

    .line 377
    const-string v7, "has_attachment"

    iget v8, p0, Lcom/miui/notes/gtask/data/SqlNote;->mHasAttachment:I
    ...
    iget-wide v8, p0, Lcom/miui/notes/gtask/data/SqlNote;->mModifiedDate:J
    ...
    iget-wide v8, p0, Lcom/miui/notes/gtask/data/SqlNote;->mParentId:J
    ...
    iget-object v8, p0, Lcom/miui/notes/gtask/data/SqlNote;->mSnippet:Ljava/lang/String;
    ...
    iget v8, p0, Lcom/miui/notes/gtask/data/SqlNote;->mWidgetId:I
    ...
    iget v8, p0, Lcom/miui/notes/gtask/data/SqlNote;->mWidgetType:I

    invoke-virtual {v5, v7, v8}, Lorg/json/JSONObject;->put(Ljava/lang/String;I)Lorg/json/JSONObject;

    .line 384
    const-string v7, "origin_parent_id"

    iget-wide v8, p0, Lcom/miui/notes/gtask/data/SqlNote;->mOriginParent:J
    ...
    iget-object v7, p0, Lcom/miui/notes/gtask/data/SqlNote;->mDataList:Ljava/util/ArrayList;
...
.method public setContent(Lorg/json/JSONObject;)Z
    ...
    iput-wide v0, v2, Lcom/miui/notes/gtask/data/SqlNote;->mAlertDate:J
    ...
    iput v0, v1, Lcom/miui/notes/gtask/data/SqlNote;->mBgColorId:I
    ...
    iput-wide v0, v2, Lcom/miui/notes/gtask/data/SqlNote;->mCreatedDate:J
    ...
    iput v0, v1, Lcom/miui/notes/gtask/data/SqlNote;->mHasAttachment:I
    ...
    invoke-virtual {v0, v1}, Lcom/miui/notes/gtask/data/SqlData;->setContent(Lorg/json/JSONObject;)V
    :try_end_1
    .catch Lorg/json/JSONException; {:try_start_1 .. :try_end_1} :catch_0
