...
.method private writeAttrValueAsInlineStr(Lorg/w3c/dom/Element;Ljava/lang/String;)V
    ...
    .end local v1           #attrValue:Ljava/lang/StringBuffer;
    :cond_1
    move-object v6, v5
...
.method private writeAttribute(Lorg/w3c/dom/Element;B)Ljava/lang/String;
    ...
    .line 306
    iget-object v5, p0, Lcom/android/mms/jwap_port/WBXMLDecoder;->tokenRepository:Lcom/android/mms/jwap_port/TokenRepository;

    invoke-virtual {v5, p2}, Lcom/android/mms/jwap_port/TokenRepository;->getAttributeNameAndPrefix(B)[Ljava/lang/String;
    ...
    .end local v0           #attrNode:Lorg/w3c/dom/Attr;
    .end local v4           #hasPrefix:Z
    :cond_1
    move v4, v7
...
.method private writeEntityAsAttribute(Lorg/w3c/dom/Element;Ljava/lang/String;)V
    ...
    .line 383
    .restart local v0       #aChar:B
    .restart local v1       #attrValue:Ljava/lang/StringBuffer;
    :cond_1
    invoke-static {v0, v8}, Ljava/lang/Integer;->toString(II)Ljava/lang/String;
...
.method public decodeProlog()Z
    ...
    .line 102
    .local v1, charset:B
    iget-object v6, p0, Lcom/android/mms/jwap_port/WBXMLDecoder;->mContext:Landroid/content/Context;

    const-string v7, "jwap_port/charsets"

    invoke-static {v6, v7}, Lcom/android/mms/jwap_port/TransTable;->getTable(Landroid/content/Context;Ljava/lang/String;)Lcom/android/mms/jwap_port/TransTable;

    move-result-object v6

    invoke-virtual {v6, v1}, Lcom/android/mms/jwap_port/TransTable;->code2str(I)Ljava/lang/String;

    move-result-object v6

    iput-object v6, p0, Lcom/android/mms/jwap_port/WBXMLDecoder;->encoding:Ljava/lang/String;
    ...
    invoke-virtual {v6, v0, v8, v4}, Ljava/io/DataInputStream;->read([BII)I
    ...
    iput-object v6, p0, Lcom/android/mms/jwap_port/WBXMLDecoder;->stringTable:Ljava/lang/String;
    :try_end_0
