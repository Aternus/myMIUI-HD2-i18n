...
.method public static checkAndCallFestival(Landroid/content/Context;Ljava/lang/String;J)V
    ...
    .line 212
    sget-object v1, Lcom/android/mms/ui/FestivalActivity;->mKeywords:[Ljava/lang/String;
...
.method private init()V
    ...
    .prologue
    const-string v9, "festival/words"
    ...
    invoke-virtual {v5, v9}, Landroid/content/res/AssetManager;->list(Ljava/lang/String;)[Ljava/lang/String;
...
.method private playAnimation1()V
    ...
    iget v0, v0, Lcom/android/mms/ui/FestivalActivity;->mDisplayWidth:I
    ...
    iget v0, v0, Lcom/android/mms/ui/FestivalActivity;->mDisplayHeight:I
    ...
    .line 133
    .local v15, startFactor:F
    const v13, 0x3e99999a

    .line 135
    .local v13, endFactor:F
    const/16 v18, 0xbb
    ...
    iget-object v0, v0, Lcom/android/mms/ui/FestivalActivity;->mBigwordView:Landroid/widget/ImageView;

    move-object v2, v0

    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/mms/ui/FestivalActivity;->mBigWordDrawable:Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct/range {v2 .. v7}, Lcom/android/mms/ui/FestivalActivity;->setPosition(Landroid/view/View;IIII)V
    ...
    const v11, 0x439b8000

    const v12, 0x43fb8000

    invoke-direct/range {v6 .. v12}, Landroid/view/animation/ScaleAnimation;-><init>(FFFFFF)V

    .line 145
    .local v6, sa:Landroid/view/animation/ScaleAnimation;
    ...
    invoke-virtual {v6, v2}, Landroid/view/animation/ScaleAnimation;->setFillAfter(Z)V

    .line 147
    new-instance v2, Lcom/android/mms/ui/FestivalActivity$3;

    move-object v0, v2

    move-object/from16 v1, p0

    invoke-direct {v0, v1}, Lcom/android/mms/ui/FestivalActivity$3;-><init>(Lcom/android/mms/ui/FestivalActivity;)V

    invoke-virtual {v6, v2}, Landroid/view/animation/ScaleAnimation;->setAnimationListener(Landroid/view/animation/Animation$AnimationListener;)V
    ...
    invoke-virtual {v2, v6}, Landroid/widget/ImageView;->setAnimation(Landroid/view/animation/Animation;)V

    .line 164
    invoke-virtual {v6}, Landroid/view/animation/ScaleAnimation;->startNow()V
