...
.method private copy(Ljava/io/RandomAccessFile;Ljava/io/RandomAccessFile;J)V
    ...
    :goto_1
    invoke-virtual {p1, v0, v6, v4}, Ljava/io/RandomAccessFile;->read([BII)I
...
.method private createModifiedCopy(Lentagged/audioformats/Tag;Lentagged/audioformats/asf/data/AsfHeader;Ljava/io/RandomAccessFile;Ljava/io/RandomAccessFile;Z)V
    ...
    .line 113
    .local v7, chunks:[Lentagged/audioformats/asf/data/Chunk;
    const-wide/16 v8, 0x0

    .line 114
    .local v8, fileSizeDifference:J
    invoke-virtual/range {p2 .. p2}, Lentagged/audioformats/asf/data/AsfHeader;->getChunkCount()J

    move-result-wide v5

    .line 116
    .local v5, chunkCount:J
    const-wide/16 v11, -0x1

    .line 121
    .local v11, newFileHeaderPos:J
    ...
    invoke-virtual {v13}, Lentagged/audioformats/asf/data/FileHeader;->getFileSize()Ljava/math/BigInteger;
...
.method private deleteExtendedContentDescription(Lentagged/audioformats/asf/data/ExtendedContentDescription;Lentagged/audioformats/Tag;)Z
    ...
    const-string v6, "WM/AlbumTitle"

    aput-object v6, v4, v5

    const/4 v5, 0x4

    const-string v6, "WM/Year"
...
.method private getOrderedChunks(Lentagged/audioformats/asf/data/AsfHeader;)[Lentagged/audioformats/asf/data/Chunk;
    ...
    new-array v4, v4, [Lentagged/audioformats/asf/data/Chunk;
    ...
    .line 390
    .local v3, tmp:[Lentagged/audioformats/asf/data/Chunk;
    new-instance v4, Lentagged/audioformats/asf/util/ChunkPositionComparator;

    invoke-direct {v4}, Lentagged/audioformats/asf/util/ChunkPositionComparator;-><init>()V
