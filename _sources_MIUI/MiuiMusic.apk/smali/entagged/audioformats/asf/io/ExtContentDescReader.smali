...
.method private parseData(Ljava/io/RandomAccessFile;)Lentagged/audioformats/asf/data/ExtendedContentDescription;
    ...
    .line 85
    .local v11, result:Lentagged/audioformats/asf/data/ExtendedContentDescription;
    ...
    .line 88
    .local v7, guid:Lentagged/audioformats/asf/data/GUID;
    sget-object v14, Lentagged/audioformats/asf/data/GUID;->GUID_EXTENDED_CONTENT_DESCRIPTION:Lentagged/audioformats/asf/data/GUID;

    invoke-virtual {v14, v7}, Lentagged/audioformats/asf/data/GUID;->equals(Ljava/lang/Object;)Z
    ...
    .line 95
    .local v5, descriptorCount:J
    new-instance v11, Lentagged/audioformats/asf/data/ExtendedContentDescription;

    .end local v11           #result:Lentagged/audioformats/asf/data/ExtendedContentDescription;
    invoke-direct {v11, v3, v4, v2}, Lentagged/audioformats/asf/data/ExtendedContentDescription;-><init>(JLjava/math/BigInteger;)V

    .line 97
    .restart local v11       #result:Lentagged/audioformats/asf/data/ExtendedContentDescription;
    ...
    .line 99
    .local v12, tagElement:Ljava/lang/String;
    invoke-static/range {p1 .. p1}, Lentagged/audioformats/asf/util/Utils;->readUINT16(Ljava/io/RandomAccessFile;)I
    ...
    .line 100
    .local v13, type:I
    new-instance v10, Lentagged/audioformats/asf/data/ContentDescriptor;

    invoke-direct {v10, v12, v13}, Lentagged/audioformats/asf/data/ContentDescriptor;-><init>(Ljava/lang/String;I)V

    .line 101
    .local v10, prop:Lentagged/audioformats/asf/data/ContentDescriptor;
    ...
    const-string v15, "Invalid datatype: "
    ...
    invoke-virtual {v10, v14}, Lentagged/audioformats/asf/data/ContentDescriptor;->setStringValue(Ljava/lang/String;)V

    .line 130
    :goto_1
    invoke-virtual {v11, v10}, Lentagged/audioformats/asf/data/ExtendedContentDescription;->addDescriptor(Lentagged/audioformats/asf/data/ContentDescriptor;)V
    ...
    invoke-virtual {v10, v14}, Lentagged/audioformats/asf/data/ContentDescriptor;->setBinaryValue([B)V
    ...
    invoke-virtual {v10, v14}, Lentagged/audioformats/asf/data/ContentDescriptor;->setBooleanValue(Z)V
    ...
    invoke-virtual {v10, v14, v15}, Lentagged/audioformats/asf/data/ContentDescriptor;->setDWordValue(J)V
    ...
    invoke-virtual {v10, v14}, Lentagged/audioformats/asf/data/ContentDescriptor;->setWordValue(I)V
    ...
    invoke-virtual {v10, v14, v15}, Lentagged/audioformats/asf/data/ContentDescriptor;->setQWordValue(J)V

    goto :goto_1

    .line 133
    .end local v2           #chunkLen:Ljava/math/BigInteger;
    .end local v5           #descriptorCount:J
    .end local v8           #i:J
    .end local v10           #prop:Lentagged/audioformats/asf/data/ContentDescriptor;
    .end local v12           #tagElement:Ljava/lang/String;
