...
.method public read(Ljava/nio/ByteBuffer;[ZB)Lentagged/audioformats/mp3/Id3v2Tag;
    ...
    .line 171
    .local v12, tagSize:I
    new-instance v11, Lentagged/audioformats/mp3/Id3v2Tag;

    invoke-direct {v11}, Lentagged/audioformats/mp3/Id3v2Tag;-><init>()V

    .line 176
    .local v11, tag:Lentagged/audioformats/mp3/Id3v2Tag;
    sget-byte v14, Lentagged/audioformats/mp3/Id3v2Tag;->ID3V23:B
    ...
    sget-byte v14, Lentagged/audioformats/mp3/Id3v2Tag;->ID3V24:B
    ...
    invoke-direct {v0, v1, v2}, Lentagged/audioformats/mp3/util/Id3v24TagReader;->processExtendedHeader(Ljava/nio/ByteBuffer;B)I

    .line 185
    :cond_1
    sget-byte v14, Lentagged/audioformats/mp3/Id3v2Tag;->ID3V22:B
    ...
    invoke-direct {v0, v1, v2}, Lentagged/audioformats/mp3/util/Id3v24TagReader;->readSize(Ljava/nio/ByteBuffer;I)I
    ...
    const-string v16, " Frame size error, skiping the rest of the tag:"
    ...
    .line 233
    .local v7, f:Lentagged/audioformats/mp3/util/id3frames/Id3Frame;
    :try_start_0
    move-object/from16 v0, p0
    ...
    invoke-direct {v0, v1, v2, v3}, Lentagged/audioformats/mp3/util/Id3v24TagReader;->createId3Frame(Ljava/lang/String;[BB)Lentagged/audioformats/mp3/util/id3frames/Id3Frame;
    :try_end_0
    ...
    .line 241
    invoke-virtual {v11, v7}, Lentagged/audioformats/mp3/Id3v2Tag;->add(Lentagged/audioformats/generic/TagField;)V

    .line 187
    .end local v7           #f:Lentagged/audioformats/mp3/util/id3frames/Id3Frame;
    :cond_8
    ...
    .line 234
    .restart local v7       #f:Lentagged/audioformats/mp3/util/id3frames/Id3Frame;
    :catch_0
    move-exception v13
