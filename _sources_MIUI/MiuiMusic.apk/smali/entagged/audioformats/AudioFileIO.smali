...
.method private prepareReadersAndWriters()V
    ...
    new-instance v3, Lentagged/audioformats/mp3/Mp3FileReader;

    invoke-direct {v3}, Lentagged/audioformats/mp3/Mp3FileReader;-><init>()V
    ...
    new-instance v3, Lentagged/audioformats/flac/FlacFileReader;

    invoke-direct {v3}, Lentagged/audioformats/flac/FlacFileReader;-><init>()V
    ...
    new-instance v3, Lentagged/audioformats/mpc/MpcFileReader;

    invoke-direct {v3}, Lentagged/audioformats/mpc/MpcFileReader;-><init>()V
    ...
    iget-object v3, p0, Lentagged/audioformats/AudioFileIO;->readers:Ljava/util/Hashtable;
    ...
    new-instance v3, Lentagged/audioformats/ape/MonkeyFileReader;

    invoke-direct {v3}, Lentagged/audioformats/ape/MonkeyFileReader;-><init>()V
    ...
    new-instance v3, Lentagged/audioformats/mp3/Mp3FileWriter;

    invoke-direct {v3}, Lentagged/audioformats/mp3/Mp3FileWriter;-><init>()V
    ...
    new-instance v3, Lentagged/audioformats/flac/FlacFileWriter;

    invoke-direct {v3}, Lentagged/audioformats/flac/FlacFileWriter;-><init>()V
    ...
    new-instance v3, Lentagged/audioformats/mpc/MpcFileWriter;

    invoke-direct {v3}, Lentagged/audioformats/mpc/MpcFileWriter;-><init>()V
    ...
    iget-object v3, p0, Lentagged/audioformats/AudioFileIO;->writers:Ljava/util/Hashtable;
    ...
    new-instance v3, Lentagged/audioformats/ape/MonkeyFileWriter;

    invoke-direct {v3}, Lentagged/audioformats/ape/MonkeyFileWriter;-><init>()V
...
.method public deleteTag(Lentagged/audioformats/AudioFile;)V
    ...
    const-string v4, "No Deleter associated to this extension: "
    ...
    invoke-virtual {v0, p1}, Lentagged/audioformats/generic/AudioFileWriter;->delete(Lentagged/audioformats/AudioFile;)V
