...
.method public static buildSendFile(Ljava/util/ArrayList;)Landroid/content/Intent;
    ...
    iget-boolean v8, v0, Lcom/android/fileexplorer/FileInfo;->IsDir:Z
    ...
    iget-object v8, v0, Lcom/android/fileexplorer/FileInfo;->filePath:Ljava/lang/String;
    ...
    invoke-static {v8}, Landroid/media/MediaFile;->getMIMEType(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 98
    .end local p0           #files:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/fileexplorer/FileInfo;>;"
    :goto_1
    return-object v8

    .line 86
    .restart local p0       #files:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/fileexplorer/FileInfo;>;"
    :cond_2
    invoke-virtual {v7}, Ljava/util/ArrayList;->size()I
    ...
    invoke-virtual {v3, v11, v7}, Landroid/content/Intent;->putParcelableArrayListExtra(Ljava/lang/String;Ljava/util/ArrayList;)Landroid/content/Intent;
    ...
    invoke-virtual {v3, v11, p0}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;
...
.method public static viewFile(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 64
    invoke-virtual {v0, v6}, Landroid/app/AlertDialog$Builder;->setContextMenuMode(Z)Landroid/app/AlertDialog$Builder;
