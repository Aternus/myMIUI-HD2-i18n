...
.method private getProxyList()[Ljava/lang/String;
    ...
    const-string v8, "preferred_server"
...
.method private newAuthedSocket(Ljava/lang/String;I)Ljava/net/Socket;
    ...
    .line 372
    iget-object v8, p0, Lorg/swiftp/ProxyConnector;->myLog:Lorg/swiftp/MyLog;

    const-string v9, "newAuthedSocket can\'t connect to null host"

    invoke-virtual {v8, v9}, Lorg/swiftp/MyLog;->i(Ljava/lang/String;)V
    ...
    const-string v10, "Opening proxy connection to "
    ...
    invoke-virtual {v8, v9}, Lorg/swiftp/MyLog;->d(Ljava/lang/String;)V
    ...
    .line 386
    const-string v8, "swiftp_version"
    ...
    const-string v10, "Sent login request"

    invoke-virtual {v8, v9, v10}, Lorg/swiftp/MyLog;->l(ILjava/lang/String;)V
    ...
    const-string v10, "Proxy socket closed while waiting for auth response"
    ...
    const-string v10, "Short network read waiting for auth, quitting"
    ...
    const-string v9, "newAuthedSocket successful"
    ...
    const-string v10, "Exception during proxy connection or authentication: "
...
.method public dataPortConnect(Ljava/net/InetAddress;I)Ljava/net/Socket;
    ...
    const-string v5, "Sending data_port_connect to proxy"

    invoke-virtual {v4, v5}, Lorg/swiftp/MyLog;->d(Ljava/lang/String;)V

    .line 610
    iget-object v4, p0, Lorg/swiftp/ProxyConnector;->hostname:Ljava/lang/String;

    const/16 v5, 0x8ae

    invoke-direct {p0, v4, v5}, Lorg/swiftp/ProxyConnector;->newAuthedSocket(Ljava/lang/String;I)Ljava/net/Socket;
    ...
    const-string v5, "dataPortConnect got null socket"
    ...
    :cond_0
    const-string v4, "data_port_connect"
    ...
    const-string v5, "JSONException in dataPortConnect"
...
.method public pasvAccept(Ljava/net/Socket;)Z
    ...
    .line 644
    :try_start_0
    const-string v3, "data_pasv_accept"

    invoke-direct {p0, v3}, Lorg/swiftp/ProxyConnector;->makeJsonRequest(Ljava/lang/String;)Lorg/json/JSONObject;
    ...
    const-string v4, "Error response to data_pasv_accept"
    ...
    const-string v4, "Proxy data_pasv_accept successful"
    ...
    const-string v5, "JSONException in pasvAccept: "
...
.method public pasvListen()Lorg/swiftp/ProxyDataSocketInfo;
    ...
    const-string v6, "Sending data_pasv_listen to proxy"
    ...
    const-string v6, "pasvListen got null socket"
    ...
    :cond_0
    const-string v5, "data_pasv_listen"
    ...
    .line 594
    .local v1, port:I
    new-instance v5, Lorg/swiftp/ProxyDataSocketInfo;

    invoke-direct {v5, v4, v1}, Lorg/swiftp/ProxyDataSocketInfo;-><init>(Ljava/net/Socket;I)V
    :try_end_0
    .catch Lorg/json/JSONException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v7, "JSONException in pasvListen"
...
.method persistProxyUsage()V
    ...
    .prologue
    const-string v6, "proxy_usage_data"
...
.method public sendRequest(Ljava/io/InputStream;Ljava/io/OutputStream;Lorg/json/JSONObject;)Lorg/json/JSONObject;
    ...
    const-string v5, "Proxy sendRequest short read on response"
    ...
    const-string v5, "Null response to sendRequest"
    ...
    const-string v5, "Error response to sendRequest"
    ...
    const-string v6, "IOException in proxy sendRequest: "
...
.method public sendRequest(Ljava/net/Socket;Lorg/json/JSONObject;)Lorg/json/JSONObject;
    ...
    invoke-virtual {v1, v2}, Lorg/swiftp/MyLog;->i(Ljava/lang/String;)V
    ...
    const-string v3, "IOException in proxy sendRequest wrapper: "
