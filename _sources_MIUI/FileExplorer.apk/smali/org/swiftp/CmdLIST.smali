...
.method protected makeLsString(Ljava/io/File;)Ljava/lang/String;
    ...
    .line 108
    sget-object v10, Lorg/swiftp/CmdLIST;->staticLog:Lorg/swiftp/MyLog;

    const-string v11, "makeLsString had nonexistent file"

    invoke-virtual {v10, v12, v11}, Lorg/swiftp/MyLog;->l(ILjava/lang/String;)V
    ...
    const-string v11, "Filename omitted due to disallowed character"
...
.method public run()V
    ...
    iget-object v5, p0, Lorg/swiftp/FtpCmd;->myLog:Lorg/swiftp/MyLog;
