...
.method protected declared-synchronized setServiceUri(Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-static {p1}, Lcom/google/common/util/text/UriUtil;->isHttps(Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-super {p0}, Lcom/google/masf/protocol/SimpleRequest;->flagSecure()V

    :cond_0
    invoke-super {p0, p1}, Lcom/google/masf/protocol/SimpleRequest;->setServiceUri(Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
