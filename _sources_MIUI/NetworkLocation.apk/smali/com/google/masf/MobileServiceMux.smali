...
.method private disposeRequests([Ljava/lang/Object;)V
    ...
    check-cast p0, Lcom/google/masf/protocol/Request;

    if-eqz p0, :cond_0

    invoke-virtual {p0}, Lcom/google/masf/protocol/Request;->dispose()V
...
.method private getListeners()[Lcom/google/masf/MobileServiceMux$Listener;
    ...
    new-array v1, v1, [Lcom/google/masf/MobileServiceMux$Listener;
...
.method private getMacroRequestPayload([Lcom/google/masf/protocol/Request;)Ljava/io/InputStream;
    ...
    invoke-direct {v3, v0}, Lcom/google/common/io/SequenceInputStream;-><init>([Ljava/io/InputStream;)V
...
.method private getSecureRequests([Lcom/google/masf/protocol/Request;)[Lcom/google/masf/protocol/Request;
    ...
    invoke-virtual {v3}, Lcom/google/masf/protocol/Request;->isSecure()Z
    ...
    new-array v2, v2, [Lcom/google/masf/protocol/Request;

    :cond_0
    sget-object v3, Lcom/google/masf/MobileServiceMux;->logger:Lcom/google/debug/LogSource;
    ...
    invoke-virtual {v3, v4}, Lcom/google/debug/LogSource;->fine(Ljava/lang/Object;)V
    ...
    invoke-virtual {v3}, Lcom/google/masf/protocol/Request;->isImmediate()Z
...
.method private handleMacroResponse(Lcom/google/common/async/AsyncHttpRequest;[Lcom/google/masf/protocol/Request;)V
    ...
    const-string v1, "MobileServiceMux.Worker.handleResponses()"

    const-string v10, "Request didn\'t complete"

    const-string v9, "MobileServiceMux.Worker.handleResponses() - requeuing any unhandled requests"
    ...
    new-instance v4, Lcom/google/masf/protocol/ProtocolReader;

    invoke-direct {v4, v1}, Lcom/google/masf/protocol/ProtocolReader;-><init>(Ljava/io/DataInputStream;)V
    ...
    invoke-virtual {v4}, Lcom/google/masf/protocol/ProtocolReader;->getNextResponse()Lcom/google/masf/protocol/Response;
    ...
    sget-object v6, Lcom/google/masf/MobileServiceMux;->logger:Lcom/google/debug/LogSource;
    ...
    invoke-virtual {v6, v7}, Lcom/google/debug/LogSource;->fine(Ljava/lang/Object;)V
    ...
    :goto_4
    invoke-virtual {v1}, Lcom/google/masf/protocol/Response;->getStatusCode()I
    ...
    invoke-virtual {v1}, Lcom/google/masf/protocol/Response;->bufferAndDetach()V

    new-instance v1, Lcom/google/masf/ConnectionException;

    invoke-direct {v1, v3}, Lcom/google/masf/ConnectionException;-><init>(I)V

    invoke-static {}, Lcom/google/common/Config;->getInstance()Lcom/google/common/Config;

    move-result-object v3

    invoke-virtual {v3}, Lcom/google/common/Config;->getClock()Lcom/google/common/Clock;
    ...
    invoke-direct {p0, v2, v1, v6, v7}, Lcom/google/masf/MobileServiceMux;->requeueRequest(Lcom/google/masf/protocol/Request;Ljava/lang/Exception;J)Z
    ...
    invoke-virtual {v1, v9}, Lcom/google/debug/LogSource;->fine(Ljava/lang/Object;)V
    ...
    :cond_7
    :try_start_6
    invoke-virtual {v4}, Lcom/google/masf/protocol/ProtocolReader;->close()V
    :try_end_6
    ...
    invoke-virtual {v2, v9}, Lcom/google/debug/LogSource;->fine(Ljava/lang/Object;)V
...
.method public static declared-synchronized initialize(Lcom/google/masf/MobileServiceMux$Configuration;)V
    ...
    new-instance v1, Lcom/google/masf/MobileServiceMux;

    invoke-direct {v1, p0}, Lcom/google/masf/MobileServiceMux;-><init>(Lcom/google/masf/MobileServiceMux$Configuration;)V

    sput-object v1, Lcom/google/masf/MobileServiceMux;->mux:Lcom/google/masf/MobileServiceMux;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static declared-synchronized initialize(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_0
    new-instance v1, Lcom/google/masf/MobileServiceMux$Configuration;

    invoke-direct {v1}, Lcom/google/masf/MobileServiceMux$Configuration;-><init>()V

    invoke-virtual {v1, p0}, Lcom/google/masf/MobileServiceMux$Configuration;->setServerUri(Ljava/lang/String;)V

    invoke-virtual {v1, p1}, Lcom/google/masf/MobileServiceMux$Configuration;->setApplicationName(Ljava/lang/String;)V

    invoke-virtual {v1, p2}, Lcom/google/masf/MobileServiceMux$Configuration;->setApplicationVersion(Ljava/lang/String;)V

    invoke-virtual {v1, p3}, Lcom/google/masf/MobileServiceMux$Configuration;->setPlatformId(Ljava/lang/String;)V

    invoke-virtual {v1, p4}, Lcom/google/masf/MobileServiceMux$Configuration;->setDistributionChannel(Ljava/lang/String;)V

    invoke-static {v1}, Lcom/google/masf/MobileServiceMux;->initialize(Lcom/google/masf/MobileServiceMux$Configuration;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private processRequests([Lcom/google/masf/protocol/Request;Z)V
    ...
    invoke-virtual {p0, v3, p2}, Lcom/google/masf/MobileServiceMux;->sendMacroRequest(Ljava/util/Vector;Z)V
...
.method private removeExtraResponses(Lcom/google/masf/protocol/SimpleRequest;Lcom/google/masf/protocol/MultipartResponse;)Lcom/google/masf/protocol/Response;
    ...
    new-instance v4, Lcom/google/masf/protocol/MultipartResponseBuilder;
    ...
    invoke-direct {v4, v1, v2, v5}, Lcom/google/masf/protocol/MultipartResponseBuilder;-><init>(IILcom/google/masf/protocol/BodyPart;)V
    ...
    :cond_1
    invoke-virtual {v4, v8}, Lcom/google/masf/protocol/MultipartResponseBuilder;->addBodyPart(Lcom/google/masf/protocol/BodyPart;)V
    ...
    invoke-virtual {v4}, Lcom/google/masf/protocol/MultipartResponseBuilder;->toMultipartResponse()Lcom/google/masf/protocol/MultipartResponse;
...
.method private requeueOrFailRequests([Lcom/google/masf/protocol/Request;Ljava/lang/Exception;)V
    ...
    iget-object v2, p0, Lcom/google/masf/MobileServiceMux;->mutex:Ljava/lang/Object;
    ...
    invoke-direct {p0, v4, p2, v0, v1}, Lcom/google/masf/MobileServiceMux;->requeueRequest(Lcom/google/masf/protocol/Request;Ljava/lang/Exception;J)Z

    move-result v4

    if-eqz v4, :cond_0

    sget-object v4, Lcom/google/masf/MobileServiceMux;->logger:Lcom/google/debug/LogSource;
...
.method private scheduleDelayedFlush()V
    ...
    iget-object v5, p0, Lcom/google/masf/MobileServiceMux;->delayedRequestQueue:Ljava/util/Hashtable;
    ...
    iget-object v5, p0, Lcom/google/masf/MobileServiceMux;->preemptableRequestMap:Ljava/util/Hashtable;
    ...
    invoke-virtual {v5}, Lcom/google/common/Config;->getClock()Lcom/google/common/Clock;

    move-result-object v5

    invoke-interface {v5}, Lcom/google/common/Clock;->currentTimeMillis()J
    ...
    invoke-virtual {v0, v3, v4}, Lcom/google/common/task/TimerTask;->setDeadline(J)V
...
.method protected processRequests()V
    ...
    invoke-direct {p0, v1, v2}, Lcom/google/masf/MobileServiceMux;->scheduleDelayedRequests(J)V

    invoke-direct {p0, v1, v2}, Lcom/google/masf/MobileServiceMux;->scheduleResendRequests(J)V

    invoke-direct {p0}, Lcom/google/masf/MobileServiceMux;->updateSentCounter()V

    invoke-direct {p0}, Lcom/google/masf/MobileServiceMux;->scheduleDelayedFlush()V

    iget-object v1, p0, Lcom/google/masf/MobileServiceMux;->submitRequestQueue:Ljava/util/Vector;
    ...
    new-array v1, v1, [Lcom/google/masf/protocol/Request;
    ...
    invoke-direct {p0, v1}, Lcom/google/masf/MobileServiceMux;->getSecureRequests([Lcom/google/masf/protocol/Request;)[Lcom/google/masf/protocol/Request;
    ...
    invoke-direct {p0, v0, v2}, Lcom/google/masf/MobileServiceMux;->processRequests([Lcom/google/masf/protocol/Request;Z)V

    :cond_1
    const/4 v0, 0x0

    invoke-direct {p0, v1, v0}, Lcom/google/masf/MobileServiceMux;->processRequests([Lcom/google/masf/protocol/Request;Z)V
...
.method public submitRequest(Lcom/google/masf/protocol/Request;Z)V
    ...
    invoke-virtual {p1, v1}, Lcom/google/masf/protocol/Request;->setId(I)V
