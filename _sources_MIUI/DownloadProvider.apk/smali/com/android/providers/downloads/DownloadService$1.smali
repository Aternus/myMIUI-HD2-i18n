...
# direct methods
.method constructor <init>(Lcom/android/providers/downloads/DownloadService;ZLandroid/net/Uri;ZLandroid/content/ContentResolver;JLjava/lang/String;)V
    .locals 0
    .parameter
    .parameter
    .parameter
    ...
    iput-object p5, p0, Lcom/android/providers/downloads/DownloadService$1;->val$resolver:Landroid/content/ContentResolver;

    iput-wide p6, p0, Lcom/android/providers/downloads/DownloadService$1;->val$id:J

    iput-object p8, p0, Lcom/android/providers/downloads/DownloadService$1;->val$mimeType:Ljava/lang/String;
...
.method public scanCompleted(Ljava/lang/String;Landroid/net/Uri;)V
    ...
    .line 681
    :cond_3
    iget-object v1, p0, Lcom/android/providers/downloads/DownloadService$1;->val$resolver:Landroid/content/ContentResolver;

    iget-wide v2, p0, Lcom/android/providers/downloads/DownloadService$1;->val$id:J

    iget-object v4, p0, Lcom/android/providers/downloads/DownloadService$1;->val$mimeType:Ljava/lang/String;

    invoke-static {v1, v2, v3, p1, v4}, Lcom/android/providers/downloads/Helpers;->deleteFile(Landroid/content/ContentResolver;JLjava/lang/String;Ljava/lang/String;)V
