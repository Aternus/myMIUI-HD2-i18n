...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .prologue
    const-string v4, "VoiceQualityBCReceiver"
    ...
    .line 56
    const-string v1, "VoiceQualityBCReceiver"

    const-string v1, "Received BOOT_COMPLETED!"
    ...
    invoke-direct {v0, p1}, Lcom/android/phone/VoiceQualityUtility;-><init>(Landroid/content/Context;)V

    .line 59
    .local v0, util:Lcom/android/phone/VoiceQualityUtility;
    if-eqz v0, :cond_1

    .line 60
    const-string v1, "VoiceQualityBCReceiver"

    const-string v1, "Updating initial parameters!"

    invoke-static {v4, v1}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;)I

    .line 61
    invoke-virtual {v0}, Lcom/android/phone/VoiceQualityUtility;->updateParameterFromSetting()V

    .line 65
    .end local v0           #util:Lcom/android/phone/VoiceQualityUtility;
    :cond_1
